...
filelist_validation = glob.glob(r'letters/*.png')
...
filelist = glob.glob(r'letters2/*.png')
...
data_validation = pd.read_csv(r"letters.csv")
data = pd.read_csv(r"letters2.csv")



labels = data['label'].values-1
labels_validation = data_validation['label'].values-1
...
checkpoint_path = '/tmp/color/my_capsule_network'
        ...
        for iteration in range(1, n_iterations_per_epoch + 1):
            ...
            _, loss_train = sess.run(
                ...
                feed_dict={X: X_batch.reshape([-1, im_x, im_y, num_channels]),
                           y: y_batch,#credit to Hinton for concepts and Geron for example implementation
